...
export const CorporateBrands = () => {
    const brands = [
        { src: "/Logos/logoAneupiFundacion.avif", alt: "Logo de la fundación", link: "https://aneupi.com/" },
        { src: "leceni.png", alt: "Logo de la constructora", link: "https://www.constructoraleceni.com/" },
        { src: "/Logos/logoAneupiAcademia.avif", alt: "Logo de la academia", link: "https://www.academianeupi.com/" },
    ...
    useEffect(() => {
        const interval = setInterval(handleNext, 3000); // Cambio automático cada 3 segundos
        return () => clearInterval(interval);
    }, [currentIndex]);

    return(
        <div 
            className="flex flex-col w-full h-[400px] gap-5 items-center relative"
                            ...
                            <div key={index} className="flex-shrink-0 w-[180px] flex justify-center">
                                <a href={brand.link}>
                                    <img 
                                        ...
                                        width={180}
                                        height={180}
                                        className="rounded-full shadow-lg border-2 border-[#25466a]"
                                    />
                                </a>
                            </div>
                        ))}
