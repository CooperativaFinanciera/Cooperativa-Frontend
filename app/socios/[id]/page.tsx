...
const SociosPage = ({ params }: { params: { id: string } }) => {
  ...
  {params.id === "Cuentas" && (
        <div className="flex flex-wrap justify-between items-center w-full my-10 p-5 bg-gray-100 rounded-lg shadow-md gap-5">
          ...
          <div className="w-full w-full p-5 flex flex-col justify-center items-start flex-grow">
          ...
          <div className="w-full w-full p-5 flex flex-col justify-center items-center">
            ...
            <div className="flex justify-start w-full mt-3 gap-3">
              <button 
                className="bg-custom-blue text-white px-2 py-3 rounded-lg  transition duration-300 w-auto flex items-center text-left whitespace-nowrap hover:shadow-[0_0_15px_blue]"
        ...
        <div className="flex flex-wrap justify-between items-center w-full my-10 p-5 bg-gray-100 rounded-lg shadow-md gap-5 border-2 border-blue-500">
          <div className="flex-1 flex flex-col justify-center items-start p-5">
            <h2 className="text-2xl font-bold text-[#00335f] mb-5 flex items-center">
              {/* Ícono de alerta */}
              <img src="/alert.png" alt="Alerta" className=" animate-slowblink w-10 h-10 mr-3 inline-block align-middle" />
              Información importante
            </h2>
