      ...
      {params.id === "FIDEICOMISOS" && (
        <div className="-mt-20 w-full flex justify-center mt-10 bg-custom-blue-100">
          <div className="p-6 rounded-lg flex flex-col items-center w-1/">
            ...
            >
              <p className="text-center text-black text-lg font-semibold group-hover:text-custom-blue transition duration-300">
        ...
        <div className="flex justify-center w-full my-10 py-0 px-5 bg-white-100 rounded-lg shadow-md gap-10 border-transparent shadow-none">
          ...
          <div className="border-2 border-custom-blue rounded-2xl w-full sm:w-2/3 flex flex-col justify-center items-start p-7 space-y-5">
            ...
            <div className="flex items-center justify-center w-full">
              ...
              >
                <p className="text-center text-black text-m font-semibold group-hover:text-custom-blue transition duration-300">
        ...
        <div className="flex justify-center w-full my-10 py-0 px-5 bg-white-100 rounded-lg shadow-md gap-10 border-transparent shadow-none">
          ...
          <div className="w-full sm:w-2/3 flex flex-col justify-center items-start p-7">
            ...
            <div className="p-6 rounded-lg w-1/3 flex justify-center">
              <button
                onClick={() => window.location.href = ""}
                className="w-full h-12 px-6 py-3 flex items-center justify-center border-2 rounded-xl transition-all duration-300 bg-[#00335f] hover:shadow-2xl group"
              >
                <p className="text-center text-white text-lg font-medium transition duration-300">
                  Sugerencias
                </p>
              </button>
            </div>
            ...
            <div className="flex space-x-4 justify-center w-full">
              ...
              <div className="p-6 rounded-lg w-1/3 flex justify-center">
                <button
                  ...
                  className="w-full h-12 px-6 py-3 flex items-center justify-center border-2 rounded-xl transition-all duration-300 bg-[#00335f] hover:shadow-2xl group"
                >
                  <p className="text-center text-white text-lg font-medium transition duration-300 leading-none">
