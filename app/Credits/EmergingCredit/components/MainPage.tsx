...
export const MainPage = () => {
    // Definición de tipos de crédito y fórmulas basadas en fórmulas financieras estándar.
    // Las fórmulas se pueden encontrar en referencias de matemáticas financieras (por ejemplo, para el sistema francés: cuota = P * i / (1 - (1 + i)^(-n)))
    const tiposCredito = {
        "Crédito Francés": {
        descripcion:
