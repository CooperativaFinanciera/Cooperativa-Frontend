...
export const HeaderPage: React.FC = () => {
    const images = ["/homeResources/familia1.jpg", "/homeResources/familia2.jpg", "/homeResources/familia3.jpg"];
        ...
        <div className="flex flex-col w-full gap-10 mb-8">
            <div className="flex w-[1000px] items-center justify-center mx-auto"> {/* contenedor del banner - imagen */}
                <img
                    ...
                    width={1000}
                    height={300}
                    className={`w-full h-full object-cover rounded-2xl transition-all duration-1000 border-2 border-[#25466a] ${imageAnimation === 'slideUp' ? 'animate-slideUp' : 'animate-slideDown'}`}
                />
            </div>
            ...
            <div className="flex flex-col gap-3"> {/* contenedor de los requisitos generales y casos */}
                ...
                <div className="flex items-center justify-center gap-3 mt-5"> {/* contenedor del boton de atencion al cliente */}
                    <button 
                        className="bg-[#25466a] text-white font-bold p-3 rounded-lg hover:bg-orange-500 hover:text-white transition duration-300 ease-in-out"
